    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                ...
                <div class="card radius-10 bg-gradient-deepblue">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">BDT {{ $today }}</h5>
                            <div class="ms-auto">
        ...
        <!-- <div class="col">
                <div class="card radius-10 bg-gradient-orange">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">BDT {{ $month }}</h5>
                            <div class="ms-auto">
            ...
            <div class="card radius-10 bg-gradient-ibiza">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center text-white">
                        ...
                        <a class="mb-0" style="color: #fff;" href="{{ route('pending.order') }}">
                            <!-- <i class="bx bx-right-arrow-alt"></i> -->
                            Pending Order
                        </a>
                        <!-- <a class="mb-0" href="{{ route('pending.order') }}">Pending Orders</a> -->
